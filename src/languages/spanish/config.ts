...
export const FREQUENCY_SOURCE = "hermitdave/FrequencyWords OpenSubtitles 2018 es_50k + PCIC CEFR levels";

export const spanishBaseConfig: Omit<LanguageConfig, "frequency" | "soulPath"> = {
  id: "spanish",
  name: "Spanish",
  errorCategories: [
